                ...
                <div className="grid gap-6 lg:grid-cols-[minmax(0,1.3fr)_280px] lg:items-end">
                  <div>
                    ...
                    <h2 className="mt-5 font-serif text-3xl font-bold md:text-4xl">
                      {data.activeOrder.restaurantName}
                    </h2>
                    <p className="mt-3 max-w-2xl text-white/85">
                      {data.activeOrder.itemCount} items, {formatRupees(data.activeOrder.total)} total.
                    ...
                    <div className="mt-6 grid gap-3 sm:grid-cols-3">
                      ...
                      <div className="rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur-sm">
                        ...
                        <p className="mt-3 text-lg font-semibold">
                          {data.activeOrder.paymentMethod}
                        </p>
                      </div>
                      <div className="rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur-sm">
                        <div className="flex items-center gap-2 text-white/80">
                        ...
                        <p className="mt-3 text-lg font-semibold">{data.activeOrder.timeLabel}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[1.75rem] border border-white/25 bg-white/12 p-5 backdrop-blur-md">
                    ...
                    <div className="mt-5 space-y-4">
                      {data.activeOrder.timeline.map((entry) => (
                    ...
                    <Link
                      href={`/orders/${data.activeOrder.id}`}
